...
<div id="micontainer" style="background: transparent; width: 100%; height: 100%; position: absolute;">
  ...
  <center><img src="https://i.ibb.co/h1C26C8/fmaccion917.png" style="margin-top:5%" width="320px" class="img-responsive" ></center>
...
MRP.insert({ 
'url':'https://streaming3.locucionar.com/proxy/fmaccion917?mp=/stream',
'codec':'aac',
'volume':100,
'autoplay':true,
'jsevents':true,
